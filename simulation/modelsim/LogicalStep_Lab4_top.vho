...
SIGNAL \INST10|next_state~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \INST10|current_state.RETRACTED~q\,
	devoe => ww_devoe,
	o => \leds[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \INST10|current_state.FULLYEXTENDED~q\,
	devoe => ww_devoe,
	o => \leds[7]~output_o\);
...
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\sw[7]~input_o\ & (\sw[6]~input_o\ & ((!\sw[5]~input_o\)))) # (!\sw[7]~input_o\ & ((\sw[6]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\)) # (!\sw[6]~input_o\ & ((\sw[4]~input_o\) # (\sw[5]~input_o\)))))
...
-- Equation(s):
-- \INST10|Equal1~0_combout\ = (!\INST9|sreg\(1) & (\INST9|sreg\(3) & (!\INST9|sreg\(2) & !\INST9|sreg\(0))))
...
-- Equation(s):
-- \INST10|Selector3~0_combout\ = (\sw[5]~input_o\ & (\INST10|current_state.FULLYEXTENDED~q\ & !\pb[2]~input_o\))
...
-- Equation(s):
-- \INST10|Equal2~0_combout\ = (!\INST9|sreg\(0) & (\INST9|sreg\(2) & (\INST9|sreg\(1) & \INST9|sreg\(3))))
...
-- Equation(s):
-- \INST10|Selector1~2_combout\ = (!\pb[2]~input_o\ & \sw[5]~input_o\)
...
-- Equation(s):
-- \INST10|Selector0~0_combout\ = (\INST10|current_state.EXTENDING1~q\ & (!\INST10|Equal1~0_combout\ & ((\INST10|Selector1~2_combout\) # (\INST10|current_state.RETRACTED~q\)))) # (!\INST10|current_state.EXTENDING1~q\ & ((\INST10|Selector1~2_combout\) # 
-- ((\INST10|current_state.RETRACTED~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST10|current_state.EXTENDING1~q\,
	datab => \INST10|Selector1~2_combout\,
...
\INST10|next_state~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST10|next_state~0_combout\ = (!\INST9|sreg\(1) & (!\INST9|sreg\(0) & !\INST9|sreg\(2)))
...
PORT MAP (
	...
	datac => \INST9|sreg\(0),
	datad => \INST9|sreg\(2),
	combout => \INST10|next_state~0_combout\);

-- Location: LCCOMB_X15_Y6_N16
\INST10|Selector1~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST10|Selector1~3_combout\ = (\INST10|current_state.EXTENDING2~q\ & ((\INST10|Equal2~0_combout\) # ((\INST10|current_state.EXTENDING1~q\ & !\INST10|next_state~0_combout\)))) # (!\INST10|current_state.EXTENDING2~q\ & (\INST10|current_state.EXTENDING1~q\ 
-- & (!\INST10|next_state~0_combout\)))
...
PORT MAP (
	...
	datac => \INST10|next_state~0_combout\,
...
-- Equation(s):
-- \INST10|Selector1~4_combout\ = (\INST10|Selector1~3_combout\) # ((\sw[5]~input_o\ & (!\INST10|current_state.RETRACTED~q\ & !\pb[2]~input_o\)))
...
PORT MAP (
	...
	datac => \pb[2]~input_o\,
	datad => \INST10|Selector1~3_combout\,
...
-- Equation(s):
-- \INST10|Selector2~0_combout\ = (\INST9|sreg\(2) & (\INST9|sreg\(1) & ((\INST9|sreg\(3))))) # (!\INST9|sreg\(2) & (!\INST9|sreg\(1) & (\INST10|current_state.EXTENDING1~q\ & !\INST9|sreg\(3))))
...
-- Equation(s):
-- \INST10|Selector2~1_combout\ = (\INST10|Selector2~0_combout\ & ((\INST9|sreg\(1) & (\INST10|current_state.EXTENDING3~q\ & \INST9|sreg\(0))) # (!\INST9|sreg\(1) & ((!\INST9|sreg\(0))))))
...
PORT MAP (
	...
	datac => \INST9|sreg\(0),
	datad => \INST10|Selector2~0_combout\,
	combout => \INST10|Selector2~1_combout\);

-- Location: LCCOMB_X15_Y6_N10
\INST10|Selector2~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST10|Selector2~2_combout\ = (\INST10|Selector2~1_combout\) # ((\INST10|current_state.EXTENDING2~q\ & (\INST10|Equal1~0_combout\ $ (!\INST10|Equal2~0_combout\))))
...
-- Equation(s):
-- \INST10|Selector3~1_combout\ = (\INST10|current_state.EXTENDING3~q\ & (((!\INST9|sreg\(1)) # (!\INST9|sreg\(3))) # (!\INST9|sreg\(2))))
...
-- Equation(s):
-- \INST10|Selector3~2_combout\ = (\INST10|Selector3~0_combout\) # ((\INST10|Selector3~1_combout\) # ((\INST10|Equal1~0_combout\ & \INST10|current_state.EXTENDING2~q\)))
...
PORT MAP (
	dataa => \INST10|Equal1~0_combout\,
	datab => \INST10|Selector3~0_combout\,
	datac => \INST10|current_state.EXTENDING2~q\,
	datad => \INST10|Selector3~1_combout\,
...
-- Equation(s):
-- \INST10|Selector4~0_combout\ = (\INST10|current_state.EXTENDING3~q\ & ((\INST10|Equal2~0_combout\) # ((!\INST10|Selector1~2_combout\ & \INST10|current_state.FULLYEXTENDED~q\)))) # (!\INST10|current_state.EXTENDING3~q\ & (!\INST10|Selector1~2_combout\ & 
-- (\INST10|current_state.FULLYEXTENDED~q\)))
...
-- Equation(s):
-- \INST1|Mux4~0_combout\ = (\sw[7]~input_o\ & (\sw[6]~input_o\ & ((\sw[5]~input_o\) # (!\sw[4]~input_o\)))) # (!\sw[7]~input_o\ & (!\sw[6]~input_o\ & (!\sw[4]~input_o\ & \sw[5]~input_o\)))
...
-- Equation(s):
-- \INST1|Mux3~0_combout\ = (\sw[5]~input_o\ & ((\sw[6]~input_o\ & ((\sw[4]~input_o\))) # (!\sw[6]~input_o\ & (\sw[7]~input_o\ & !\sw[4]~input_o\)))) # (!\sw[5]~input_o\ & (!\sw[7]~input_o\ & (\sw[6]~input_o\ $ (\sw[4]~input_o\))))
